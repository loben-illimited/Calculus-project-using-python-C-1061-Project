...
def second_layer_menu_opition_4():
...
if user_opition == 1:
    ...
    #print("4")
    result = second_layer_menu_opition_4()
    print("日出時間(local time): ", result[0])
    print("日落時間(local time): ", result[1])
    print(hr)
elif user_opition == 5:
    result = second_layer_menu_opition_5(second_layer_menu_opition_4())
